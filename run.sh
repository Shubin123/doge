...
'/Applications/love.app/Contents/MacOS/love' ./src 2 & sleep 0.3 && '/Applications/love.app/Contents/MacOS/love' ./src 1  &  '/Applications/love.app/Contents/MacOS/love' ./src 3
